...
module.exports = "<h2 class=\"page-header\">Dashboard</h2>\n<p>Welcome to Dashshing Dashboard</p>"
...
module.exports = "<h2 class=\"page-header\">Login</h2>\n<form (submit)=\"onLoginSubmit()\" class=\"card card-body mt-4\" >\n  \n  <div class=\"form-group\">\n    <label>UserName</label>\n    <input class=\"form-control\" [(ngModel)]=\"username\" name=\"username\" type=\"text\" placeholder=\"UserName\">\n  </div>\n  \n  <div class=\"form-group\">\n    <label>Password</label>\n    <input class=\"form-control\" [(ngModel)]=\"password\" name=\"password\" type=\"password\" placeholder=\"Enter Password\">\n  </div>\n  <div><input type=\"submit\" class=\"btn btn-primary\" value=\"submit\"></div>\n</form>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessage.show('You are logged in', { cssClass: 'alert alert-success', timeout: 3000 });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessage.show(data.msg, { cssClass: 'alert alert-success', timeout: 5000 });
...
module.exports = "<form (submit)=\"onRegisterSubmit()\" class=\"card card-body mt-4\" >\n  <div class=\"form-group\">\n    <label>Name</label>\n    <input class=\"form-control\" [(ngModel)]=\"name\" name=\"name\" type=\"text\" placeholder=\"Enter Name\">\n  </div>\n  <div class=\"form-group\">\n    <label>UserName</label>\n    <input class=\"form-control\" [(ngModel)]=\"username\" name=\"username\" type=\"text\" placeholder=\"UserName\">\n  </div>\n  <div class=\"form-group\">\n    <label>Email</label>\n    <input class=\"form-control\" [(ngModel)]=\"email\" name=\"email\" type=\"email\" placeholder=\"Enter Email\">\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input class=\"form-control\" [(ngModel)]=\"password\" name=\"password\" type=\"password\" placeholder=\"Enter Password\">\n  </div>\n  <div><input type=\"submit\" class=\"btn btn-primary\" value=\"submit\"></div>\n</form>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('You are registered Please Login', { cssClass: 'alert alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('sorry ', { cssClass: 'alert alert-danger', timeout: 3000 });
